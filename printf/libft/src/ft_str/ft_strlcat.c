...
/*   Updated: 2025/08/07 19:22:47 by anieto-m         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t	ft_strlcat(char *dst, const char *src, size_t dstsize) // Concatenate src to dst with a limit on the size of dst
{
	size_t	c;
	size_t	d;
